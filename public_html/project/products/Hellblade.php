...
<div><h4 class="inline">$<?php echo Common::get($item,"price"); ?></h4><button class="btn btn-success inline">Add to cart</button></div>
<span>$<?php echo Common::get($item,"price");?></span>
